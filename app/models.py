...
#     )
#     name = models.CharField(max_length=50,verbose_name="环境名")
#     version = models.CharField(max_length=30,verbose_name="版本")
#     type = models.CharField(max_length=50,verbose_name="类型",choices=ProFile)
#     ip = models.GenericIPAddressField(verbose_name="环境管理IP")
#     # node_ip = models.TextField(verbose_name="节点IP列表")
#     business = models.GenericIPAddressField(protocol='both',unpack_ipv4=False,verbose_name="执行机IP")
#     description = models.CharField(max_length=1024,blank=True,null=True,verbose_name="信息描述")
#     LastUpdateTime = models.DateTimeField(auto_now=True,verbose_name="最新修改时间")
#     status = models.BooleanField(default=True,verbose_name="状态")
#     user = models.ForeignKey(User,on_delete=models.CASCADE,verbose_name="当前拥有者",max_length=1024,null=True)
#
...
#
# class ActionProFile(models.Model):
#     """执行方式"""
#     id =models.AutoField(permary_key=True)
#     cmd = models.CharField(max_length=100,verbose_name='命令详情')
#     now = models.DateTimeField(auto_now_add=True,verbose_name='开始时间')
#     # End = models.dateField(auto_now=True,verbose_name='预期结束时间')
#
...
#         verbose_name = "执行"
#
# class PerMonEnv(models.Model):
#     """环境监控信息表"""
#     status = models.BooleanField(default=True,verbose_name="状态")
#     environmentname = models.CharField(max_length=50,verbose_name="环境名")
#     envdescription = models.TextField(max_length=1024,verbose_name="备注")
#
#     class Meta:
#         verbose_name = "环境监控信息表"
...
# V2.0功能新增 2021-4-22 K
class ExeMachine(models.Model):
    """执行机"""
    status = (
        ('正常', '正常'),
        ('关机', '关机'),
    ...
    name = models.CharField("执行机名称",max_length=128)
    ip = models.GenericIPAddressField(blank=True, null=True, verbose_name="执行机IP")
    username = models.CharField("用户名",max_length=128)
    password = models.CharField("密码",max_length=128)
    type = models.CharField(choices=exc_type,default='Windows',max_length=64 ,blank=True,null=True,
                            verbose_name="执行机类型")
    status = models.CharField(choices=status, default='正常', max_length=32,verbose_name='状态')
